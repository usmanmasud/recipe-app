    ...
    return (
        <nav className='flex justify-between py-8 container mx-auto flex-col lg:flex-row gap-5 lg:gap-0 '>
            ...
            <form onSubmit={handleSubmit}>
                <input type='text' name='search' placeholder='Enter Items...' className='bg-white/75 p-3 px-8 rounded-full outline-none lg:w-96 shadow-lg shadow-red-100 focus:shadow-red-200' value={searchParam} onChange={(e) => setSearchParam(e.target.value)} />
            </form>
